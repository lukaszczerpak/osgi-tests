...
public class HelloServiceListener implements ServiceListener {
    ...
    private static final Logger log = Logger.getLogger("HelloServiceListener");
    
    private static HelloService service = null;
    ...
    public void serviceChanged(ServiceEvent event) {
        ...
        if(sr == null) {
            ...
            service = (HelloService) bc.getService(sr);
        }
